...
--
-- Table structure for table `abonoclientes`
--

DROP TABLE IF EXISTS `abonoclientes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `abonoclientes` (
  `codigoCliente` varchar(5) DEFAULT NULL,
...
--
-- Dumping data for table `abonoclientes`
--

LOCK TABLES `abonoclientes` WRITE;
/*!40000 ALTER TABLE `abonoclientes` DISABLE KEYS */;
INSERT INTO `abonoclientes` VALUES ('1',1,100.00),('1',2,50.00),('2',3,10.00);
/*!40000 ALTER TABLE `abonoclientes` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `abonosproveedores` (
  `codigoProveedor` varchar(5) DEFAULT NULL,
  `idAbonoP` int NOT NULL,
  `abono` float(10,2) DEFAULT NULL,
  PRIMARY KEY (`idAbonoP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `abonosproveedores`
--

LOCK TABLES `abonosproveedores` WRITE;
/*!40000 ALTER TABLE `abonosproveedores` DISABLE KEYS */;
INSERT INTO `abonosproveedores` VALUES ('1',1,50.00),('1',2,50.00),('2',3,25.00);
/*!40000 ALTER TABLE `abonosproveedores` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `clientes` VALUES ('1','Juan','Mario','111','222','1','0'),('2','Ivan','15 calle','123','321','1','0'),('3','Mario Alberto','16 calle 16','123321','321123','1','0');
...
CREATE TABLE `compras_detalle` (
  ...
  KEY `compras_detalle_ibfk_3` (`estado`),
  ...
  CONSTRAINT `compras_detalle_ibfk_3` FOREIGN KEY (`estado`) REFERENCES `bodegas` (`codigo_bodega`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `compras_encabezado` VALUES ('1','1','0000-00-00',250.00,'1'),('2','1','0000-00-00',250.00,'1'),('3','2','0000-00-00',250.00,'1');
...
INSERT INTO `proveedores` VALUES ('1','Jacinto2','80 calle2','12','21','0'),('2','Luis','2','3','4','1'),('3','Mario','f','f','f','0');
...
INSERT INTO `vendedores` VALUES ('1','Pedro','15 calle','123','123','1'),('2','Alberto Marcelo','22 calle 22','123 22','321 22','1');
...
INSERT INTO `ventas_encabezado` VALUES ('1','1','0000-00-00',220.00,'1'),('2','1','0000-00-00',230.00,'1'),('3','2','0000-00-00',290.00,'1');
...
-- Dump completed on 2020-06-03 14:48:16
