...
namespace Capa_Diseño.Mantenimientos
{
    public partial class Prueba : Form
    {
        ...
        string scampo;
        string sTabla = "prueba";      //Aqui iria el nombre de la tabla a la cual se le hara el mantenimiento
        string sLlave = "COD";      //Aqui iria el nombre de la llave primaria de la tabla
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { sTabla, textBox1.Text, textBox2.Text, textBox3.Text, comboBox1.Text };
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { sTabla, textBox1.Text, textBox2.Text, textBox3.Text, comboBox1.Text };
                string[] campos = { "COD", "edad", "nombre", "estado" }; //CAMPOS DE LA TABLA
