...
namespace Capa_Diseño
{
    public partial class Menu : Form
    {
        ...
        bool ventanaSaldos= false;
        Frm_estadoCuentas saldo = new Frm_estadoCuentas();
        private void saldosCuentasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form frmC = Application.OpenForms.Cast<Form>().FirstOrDefault(x => x is Frm_estadoCuentas);
            if (ventanaSaldos == false || frmC == null)
            {
                if (frmC == null)
                {
                    saldo = new Frm_estadoCuentas();
                }

                saldo.MdiParent = this;
                saldo.Show();
                Application.DoEvents();
                ventanaSaldos = true;
            }
            ...
            {
                saldo.WindowState = System.Windows.Forms.FormWindowState.Normal;
            }
        }
    }
}
